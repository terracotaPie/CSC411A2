...
\newcommand{\hmwkDueDate}{Sunday,\ March\ 5,\ 2017} % Due date
\newcommand{\hmwkClass}{CSC411} % Course/class
\newcommand{\hmwkClassTime}{L0101} % Class/lecture time
\newcommand{\hmwkAuthorName}{Fiona Leung, Timur Borkhodoev} % Your name
...
%%TODO: insert images of the data set from jupyter here.
