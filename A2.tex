...
\usepackage{minted}
\setminted{ frame=lines, framesep=2mm, baselinestretch=1.2, linenos,gobble=2 }
...
generating a noise for our data set.
  \begin{minted}[frame=lines, framesep=2mm, baselinestretch=1.2, linenos,
mathescape,gobble=2]{python}
...
\texttt{img\_data\/tf\/actor\_imgs.p}.
...
\texttt{/img\_data/alexnet/actor\_imgs\_with\_filenames.p}.
...
The NN performed signficantly better at classifying actors on the training set
...
under \texttt{img\_data/alexnet/actor\_imgs\_with\_filename.p} using the
